...
class VariableApi:
    ...
    def bulk_variables(
        ...
        :param bulk_body_variable_body: (required)
        :type bulk_body_variable_body: BulkBodyVariableBody
        ...
        _param = self._bulk_variables_serialize(
            bulk_body_variable_body=bulk_body_variable_body,
    ...
    @validate_call
    def bulk_variables_with_http_info(
        self,
        bulk_body_variable_body: BulkBodyVariableBody,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bulk_variables_without_preload_content(
        self,
        bulk_body_variable_body: BulkBodyVariableBody,
        _request_timeout: Union[
            None,
    ...
    def _bulk_variables_serialize(
        self,
        bulk_body_variable_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if bulk_body_variable_body is not None:
            _body_params = bulk_body_variable_body
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/v2/variables',
    ...
    def _delete_variable_serialize(
        ...
        if variable_key is not None:
            _path_params['variable_key'] = variable_key
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/variables/{variable_key}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_variables(
        ...
        variable_key_pattern: Annotated[Optional[StrictStr], Field(description="Case-insensitive substring match (SQL `ILIKE`). Slower than `variable_key_prefix_pattern` on large tables — see \"Filtering with pattern parameters\".")] = None,
        variable_key_prefix_pattern: Annotated[Optional[StrictStr], Field(description="Case-sensitive, index-friendly prefix match. See \"Filtering with pattern parameters\".")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param variable_key_pattern: Case-insensitive substring match (SQL `ILIKE`). Slower than `variable_key_prefix_pattern` on large tables — see \"Filtering with pattern parameters\".
        :type variable_key_pattern: str
        :param variable_key_prefix_pattern: Case-sensitive, index-friendly prefix match. See \"Filtering with pattern parameters\".
    ...
    def get_variables_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VariableCollectionResponse]:
        """Get Variables
    ...
    def _get_variables_serialize(
        ...
        if variable_key_pattern is not None:
    ...
    def post_variable(
        ...
        _param = self._post_variable_serialize(
            variable_body=variable_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_variable_with_http_info(
        self,
        variable_body: VariableBody,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_variable_without_preload_content(
        self,
        variable_body: VariableBody,
        _request_timeout: Union[
            None,
