...
class DAGApi:
    ...
    def get_dag_tags(
        ...
        order_by: Annotated[Optional[List[Optional[StrictStr]]], Field(description="Attributes to order by, multi criteria sort is supported. Prefix with `-` for descending order. Supported attributes: `name`")] = None,
    ...
    def get_dags(
        ...
        owners: Optional[List[Optional[StrictStr]]] = None,
        ...
        dag_run_state: Optional[List[Optional[StrictStr]]] = None,
        order_by: Annotated[Optional[List[Optional[StrictStr]]], Field(description="Attributes to order by, multi criteria sort is supported. Prefix with `-` for descending order. Supported attributes: `dag_id, dag_display_name, next_dagrun, state, start_date, last_run_state, last_run_start_date`")] = None,
        is_favorite: Optional[StrictBool] = None,
        timetable_type: Optional[List[Optional[StrictStr]]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param dag_run_state:
        :type dag_run_state: List[Optional[str]]
        ...
        :type timetable_type: List[Optional[str]]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
