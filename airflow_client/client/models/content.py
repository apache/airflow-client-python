...
CONTENT_ANY_OF_SCHEMAS = ["List[StructuredLogMessage]", "List[str]"]
...
class Content(BaseModel):
    ...
    # data type: List[StructuredLogMessage]
    anyof_schema_1_validator: Optional[List[StructuredLogMessage]] = None
    # data type: List[str]
    anyof_schema_2_validator: Optional[List[StrictStr]] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[List[StructuredLogMessage], List[str]]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "List[StructuredLogMessage]", "List[str]" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        error_messages = []
        # validate data type: List[StructuredLogMessage]
        try:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Content with anyOf schemas: List[StructuredLogMessage], List[str]. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        error_messages = []
        # deserialize data into List[StructuredLogMessage]
        try:
            # validation
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Content with anyOf schemas: List[StructuredLogMessage], List[str]. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], List[StructuredLogMessage], List[str]]]:
