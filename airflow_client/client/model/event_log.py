...
class EventLog(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            map_index (int, none_type): The Map Index. [optional]  # noqa: E501
            owner (str, none_type): Name of the user who triggered these events a.. [optional]  # noqa: E501
            run_id (str, none_type): The DAG Run ID. [optional]  # noqa: E501
            task_id (str, none_type): The Task ID. [optional]  # noqa: E501
            try_number (int, none_type): The Try Number. [optional]  # noqa: E501
