...
class TestResponseClearDagRun(unittest.TestCase):
    """ResponseClearDagRun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseClearDagRun:
        """Test ResponseClearDagRun
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseClearDagRun`
        """
        model = ResponseClearDagRun()
        if include_optional:
    ...
    def testResponseClearDagRun(self):
        """Test ResponseClearDagRun"""
