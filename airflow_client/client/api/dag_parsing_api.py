...
class DAGParsingApi:
    ...
    def reparse_dag_file(
        ...
        _param = self._reparse_dag_file_serialize(
    ...
    @validate_call
    def reparse_dag_file_without_preload_content(
        self,
        file_token: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _reparse_dag_file_serialize(
        self,
        file_token,
        _request_auth,
        _content_type,
        ...
        if file_token is not None:
            _path_params['file_token'] = file_token
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v2/parseDagFile/{file_token}',
