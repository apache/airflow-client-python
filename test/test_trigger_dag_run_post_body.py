...
class TestTriggerDAGRunPostBody(unittest.TestCase):
    """TriggerDAGRunPostBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggerDAGRunPostBody:
        """Test TriggerDAGRunPostBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggerDAGRunPostBody`
        """
    ...
    def testTriggerDAGRunPostBody(self):
        """Test TriggerDAGRunPostBody"""
