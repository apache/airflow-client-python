...
class ImportErrorApi:
    ...
    def get_import_error(
        ...
        :param import_error_id: (required)
        ...
        _param = self._get_import_error_serialize(
    ...
    def get_import_error_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ImportErrorResponse]:
        """Get Import Error
    ...
    def _get_import_error_serialize(
        self,
        import_error_id,
        _request_auth,
        _content_type,
        ...
        if import_error_id is not None:
            _path_params['import_error_id'] = import_error_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/importErrors/{import_error_id}',
    ...
    def get_import_errors(
        ...
        filename_pattern: Annotated[Optional[StrictStr], Field(description="Case-insensitive substring match (SQL `ILIKE`). Slower than `filename_prefix_pattern` on large tables — see \"Filtering with pattern parameters\".")] = None,
        filename_prefix_pattern: Annotated[Optional[StrictStr], Field(description="Case-sensitive, index-friendly prefix match. See \"Filtering with pattern parameters\".")] = None,
        ...
        :param filename_pattern: Case-insensitive substring match (SQL `ILIKE`). Slower than `filename_prefix_pattern` on large tables — see \"Filtering with pattern parameters\".
        :type filename_pattern: str
        :param filename_prefix_pattern: Case-sensitive, index-friendly prefix match. See \"Filtering with pattern parameters\".
        ...
        _param = self._get_import_errors_serialize(
            limit=limit,
            offset=offset,
            order_by=order_by,
    ...
    def get_import_errors_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ImportErrorCollectionResponse]:
        """Get Import Errors
    ...
    def _get_import_errors_serialize(
        self,
        limit,
        offset,
        order_by,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/importErrors',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
