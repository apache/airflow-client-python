...
class TestResponseGetXcomEntry(unittest.TestCase):
    """ResponseGetXcomEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseGetXcomEntry:
        """Test ResponseGetXcomEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseGetXcomEntry`
        """
    ...
    def testResponseGetXcomEntry(self):
        """Test ResponseGetXcomEntry"""
