...
from airflow_client.client.api.dag_warning_api import DagWarningApi  # noqa: E501


class TestDagWarningApi(unittest.TestCase):
    """DagWarningApi unit test stubs"""

    def setUp(self):
        self.api = DagWarningApi()  # noqa: E501
