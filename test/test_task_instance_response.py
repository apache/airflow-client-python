...
class TestTaskInstanceResponse(unittest.TestCase):
    """TaskInstanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskInstanceResponse:
        """Test TaskInstanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskInstanceResponse`
        """
    ...
    def testTaskInstanceResponse(self):
        """Test TaskInstanceResponse"""
