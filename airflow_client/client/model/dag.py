...
class DAG(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'max_consecutive_failed_dag_runs': (int, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'max_consecutive_failed_dag_runs': 'max_consecutive_failed_dag_runs',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'max_consecutive_failed_dag_runs',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            max_consecutive_failed_dag_runs (int, none_type): (experimental) The maximum number of consecutive DAG failures before DAG is automatically paused.  *New in version 2.9.0* . [optional]  # noqa: E501
