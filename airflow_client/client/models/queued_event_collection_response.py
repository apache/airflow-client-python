...
class QueuedEventCollectionResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in queued_events (list)
        _items = []
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queued_events": [QueuedEventResponse.from_dict(_item) for _item in obj["queued_events"]] if obj.get("queued_events") is not None else None,
