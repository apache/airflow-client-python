...
class DagStatsApi:
    ...
    def get_dag_stats(
        ...
        _param = self._get_dag_stats_serialize(
            dag_ids=dag_ids,
    ...
    @validate_call
    def get_dag_stats_with_http_info(
        self,
        dag_ids: Optional[List[StrictStr]] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DagStatsCollectionResponse]:
        """Get Dag Stats
    ...
    @validate_call
    def get_dag_stats_without_preload_content(
        self,
        dag_ids: Optional[List[StrictStr]] = None,
        _request_timeout: Union[
            None,
