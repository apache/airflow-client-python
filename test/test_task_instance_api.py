...
from airflow_client.client.api.task_instance_api import TaskInstanceApi  # noqa: E501
...
class TestTaskInstanceApi(unittest.TestCase):
    ...
    def test_get_mapped_task_instance_dependencies(self):
        """Test case for get_mapped_task_instance_dependencies

        Get task dependencies blocking task from getting scheduled.  # noqa: E501
        """
        pass

    def test_get_mapped_task_instance_tries(self):
    ...
    def test_get_mapped_task_instance_try_details(self):
    ...
    def test_get_task_instance_dependencies(self):
    ...
    def test_get_task_instance_tries(self):
    ...
    def test_get_task_instance_try_details(self):
