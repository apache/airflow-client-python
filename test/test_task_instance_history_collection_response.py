...
class TestTaskInstanceHistoryCollectionResponse(unittest.TestCase):
    """TaskInstanceHistoryCollectionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskInstanceHistoryCollectionResponse:
        """Test TaskInstanceHistoryCollectionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskInstanceHistoryCollectionResponse`
        """
        model = TaskInstanceHistoryCollectionResponse()
        if include_optional:
    ...
    def testTaskInstanceHistoryCollectionResponse(self):
        """Test TaskInstanceHistoryCollectionResponse"""
