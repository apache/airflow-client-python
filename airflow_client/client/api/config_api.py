...
class ConfigApi:
    ...
    def get_config_value(
        ...
        _param = self._get_config_value_serialize(
            section=section,
            option=option,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_config_value_with_http_info(
        self,
        section: StrictStr,
        option: StrictStr,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_config_value_without_preload_content(
        self,
        section: StrictStr,
        option: StrictStr,
        accept: Optional[StrictStr] = None,
    ...
    def _get_config_value_serialize(
        self,
        section,
        option,
        accept,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/config/section/{section}/option/{option}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
