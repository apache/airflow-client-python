...
class TestBackfillPostBody(unittest.TestCase):
    """BackfillPostBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackfillPostBody:
        """Test BackfillPostBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackfillPostBody`
        """
        model = BackfillPostBody()
        if include_optional:
